...
public class FlowLeniaSimulation : MonoBehaviour
{
    ...
    /// <summary>Used by viewer/binder to ensure RTs exist even before Play.</summary>
    ...
    /// <summary>Clear state and reseed a center blob (use from Inspector context menu).</summary>
    ...
    void Init()
    {
        // Create RTs regardless of CS availability so UI can show something.
        MakeRT(ref stateA);
        MakeRT(ref stateB);
    ...
    void SeedCenterBlob()
    {
        ...
        for (int x = 0; x < width; x++)
        {
            ...
            cols[y * width + x] = new Color(v, v * 0.8f, v * 0.6f, 0f);
        }
    ...
    void Update()
    {
        ...
        // If no compute shader, still show the seeded texture.
