Shader \"Hidden/BrushBlit\"
{
    SubShader
    {
        Tags { \"RenderType\"=\"Opaque\" } ZTest Always Cull Off ZWrite Off
        Pass
        {
            HLSLPROGRAM
            #pragma vertex vert
            ...
            float2 _BrushCenter; float _BrushRadius; float _Hardness; float _Opacity; float _TargetValue;
            ...
            fixed4 frag(v2f i):SV_Target {
                ...
                float w = (outer>inner) ? (1.0 - saturate((d-inner)/(outer-inner))) : step(d,outer);
